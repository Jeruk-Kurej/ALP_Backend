...
exports.tokoRouter.post("/tokos", multer_util_1.uploadToko.single("image"), toko_controller_1.TokoController.create);
exports.tokoRouter.put("/tokos/:tokoId", multer_util_1.uploadToko.single("image"), toko_controller_1.TokoController.update);
